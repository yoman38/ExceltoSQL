...
Sub GenerateSQL()
    ...
    MsgBox "SQL generation complete! The output was written to " & outputFilePath, vbInformation, "Success"
End Sub
...
End Function
' Function to show a worksheet selection dialog and return the selected Worksheet object
Function SelectWorksheet(wb As Workbook) As Worksheet
    Dim i As Integer
    Dim index As Integer
    Dim name As String

    name = GetUserInput("Enter the name of the worksheet.")
    If name = "" Then Exit Function ' Exit function if user clicked Cancel
